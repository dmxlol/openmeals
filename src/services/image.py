...
class ImageManager:
    ...
    def generate_upload_url(self, entity_type: str, entity_id: str, content_type: str) -> ImageUploadResponse:
        ...
        return ImageUploadResponse(upload_url=upload_url, image_key=raw_key)
